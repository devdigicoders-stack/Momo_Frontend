  ...
  if (user?.role === 'CHEF') {
    return (
      <div className="p-8 text-center bg-white rounded-2xl border border-[#E5E7EB] shadow-xs max-w-lg mx-auto mt-10 animate-fadeIn">
        ...
        <h2 className="text-lg font-bold text-[#172033] mb-1">Access Restricted</h2>
  ...
  return (
    <div className="space-y-6 pb-12 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-gradient-to-br from-[#172033] to-[#263554] text-white rounded-2xl p-5 border border-[#232F48] shadow-md relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="my-2">
            ...
            <p className="text-[10px] text-slate-300 flex items-center gap-1 mt-0.5">
              <Sparkles className="w-3 h-3 text-[#F97316]" /> All-Time Calculated Available Cash
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-xs flex flex-col justify-between">
          ...
          <div className="my-2">
            <h3 className="text-xl lg:text-2xl font-black text-[#172033]">
              ₹{(summaryData?.openingCash || 0).toLocaleString('en-IN')}
            </h3>
            <p className="text-[10px] text-[#6B7280] mt-0.5">Balance prior to {selectedDate}</p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-xs flex flex-col justify-between">
          ...
          <div className="text-[10px] text-emerald-600 font-semibold border-t border-[#E5E7EB] pt-2">
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-xs flex flex-col justify-between">
          ...
          <div className="my-2">
            <h3 className="text-xl lg:text-2xl font-black text-rose-600">
          ...
          <div className="text-[10px] text-rose-600 font-semibold border-t border-[#E5E7EB] pt-2">
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-xs flex flex-col justify-between">
          ...
          <div className="my-2">
            <h3 className="text-xl lg:text-2xl font-black text-[#F97316]">
              ₹{(summaryData?.closingCash || 0).toLocaleString('en-IN')}
            </h3>
            <p className="text-[10px] text-[#6B7280] mt-0.5">Calculated end of {selectedDate}</p>
          </div>
          <div className="text-[10px] text-[#6B7280] border-t border-[#E5E7EB] pt-2">
      ...
      <div className="bg-white rounded-2xl p-5 sm:p-6 border border-[#E5E7EB] shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 pb-4 border-b border-[#E5E7EB]">
          <div>
            <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#FFF0E5] text-[#F97316] mb-1.5">
              <span>Automatic Balance Reconciliation</span>
            </div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center bg-[#FFF8F1] rounded-xl p-1 border border-[#E5E7EB]">
              ...
              <input
                ...
                className="bg-transparent text-xs font-bold text-[#172033] px-2 py-1 outline-none cursor-pointer"
              />
              <button
                onClick={() => handleShiftDate(1)}
                className="px-2.5 py-1 text-xs font-semibold text-[#374151] hover:bg-white rounded-lg transition cursor-pointer"
        ...
        <div className="mt-5 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-center">
          <div className="p-3.5 rounded-xl bg-[#FFF8F1]/60 border border-[#E5E7EB]">
            <p className="text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">Opening Cash</p>
            <p className="text-base font-black text-[#172033] mt-1">
              ₹{(summaryData?.openingCash || 0).toLocaleString('en-IN')}
            </p>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-orange-50 border border-orange-200">
            ...
            <p className="text-base font-black text-[#F97316] mt-1">
              ₹{(summaryData?.closingCash || 0).toLocaleString('en-IN')}
            </p>
            <span className="text-[9px] text-[#F97316] block mt-0.5">End of Day Balance</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#E5E7EB] pb-3">
        ...
        {activeTab === 'LEDGER' && (
          <button
            ...
            disabled={exporting}
            className="px-3.5 py-2 text-xs font-bold rounded-xl bg-white text-[#172033] border border-[#E5E7EB] hover:bg-gray-50 transition flex items-center gap-1.5 shadow-2xs cursor-pointer disabled:opacity-50"
          >
      ...
      {activeTab === 'LEDGER' && (
        <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-xs p-5 sm:p-6 space-y-4">
          {/* Filters Bar */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-[#FFF8F1]/60 p-3.5 rounded-xl border border-[#E5E7EB]">
            {/* Type selector */}
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap transition cursor-pointer ${
                    ledgerType === t.id
                      ...
                      : 'bg-white text-[#374151] border border-[#E5E7EB] hover:bg-[#FFF0E5]'
                  }`}
                >
                  {t.label}
                </button>
            ...
            <form onSubmit={handleSearchSubmit} className="flex flex-wrap items-center gap-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-8 pr-3 py-1.5 text-xs rounded-lg border border-[#E5E7EB] bg-white text-[#172033] outline-none focus:border-[#F97316] w-44"
                />
              </div>
              ...
              <input
                ...
                className="px-2.5 py-1.5 text-xs rounded-lg border border-[#E5E7EB] bg-white text-[#172033] outline-none cursor-pointer"
                title="Start Date"
              />
              ...
              {(searchTerm || startDate || endDate || ledgerType !== 'ALL') && (
                <button
                  ...
                  className="p-1.5 text-[#6B7280] hover:text-[#172033] rounded-lg hover:bg-white transition cursor-pointer"
                  title="Reset Filters"
                >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead className="bg-[#FFF8F1] text-[#172033] font-bold uppercase tracking-wider border-b border-[#E5E7EB]">
                  <tr>
                    <th className="p-3">Entry Code & Type</th>
                ...
                <SkeletonLoader rows={6} columns={8} asTable={true} />
              </table>
            </div>
          ) : transactions.length === 0 ? (
            <div className="text-center py-12">
              <Wallet className="w-10 h-10 text-slate-300 mx-auto mb-2" />
              <p className="text-sm font-bold text-[#172033]">No cash transactions found</p>
              <p className="text-xs text-[#6B7280] mt-1">Try clearing your search or date filters.</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                    ...
                    return (
                      <tr key={idx} className="hover:bg-[#FFF8F1]/40 transition">
                        <td className="p-3">
                          ...
                          <span className="text-[10px] text-[#6B7280] font-mono">{item.entryCode}</span>
                        </td>

                        <td className="p-3 text-[#374151] font-medium whitespace-nowrap">
                          {new Date(item.date).toLocaleDateString('en-IN', {
                            day: '2-digit',
                            month: 'short',
                            year: 'numeric',
                        ...
                        <td className="p-3 whitespace-nowrap">
                          <span
                            className={`text-sm font-black ${
                              isInflow ? 'text-[#16A34A]' : 'text-[#DC2626]'
                            }`}
                          >
                        ...
                        <td className="p-3 max-w-xs">
                          <p className="font-semibold text-[#172033] truncate">{item.summary}</p>
                          <p className="text-[11px] text-[#6B7280] truncate">{item.details}</p>
                        </td>
                        ...
                        <td className="p-3 whitespace-nowrap">
                          {item.depositSlip ? (
                            <button
                              ...
                              className="px-2.5 py-1 rounded-lg bg-blue-50 text-blue-600 text-[11px] font-bold hover:bg-blue-100 transition inline-flex items-center gap-1 cursor-pointer"
                            >
                        ...
                        <td className="p-3 whitespace-nowrap">
                          ...
                          <span className="text-[10px] text-[#6B7280] block">{item.enteredBy?.role || ''}</span>
                        </td>
      ...
      {activeTab === 'ADDITIONAL' && (
        <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-xs p-6 max-w-2xl mx-auto space-y-6">
          <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#172033]">Record Additional Cash</h3>
                <p className="text-xs text-[#6B7280]">Log cash provided by owners, managers, or counter float.</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs rounded-xl border border-[#E5E7EB] bg-[#FFF8F1]/40 text-[#172033] outline-none focus:border-emerald-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs rounded-xl border border-[#E5E7EB] bg-[#FFF8F1]/40 text-[#172033] outline-none focus:border-emerald-500 font-bold"
                />
              </div>
            </div>
            ...
            <div className="pt-3 border-t border-[#E5E7EB] flex items-center justify-end gap-2">
              <button
                ...
                className="px-4 py-2 rounded-xl text-xs font-semibold text-[#6B7280] hover:bg-gray-50 transition cursor-pointer"
              >
                Clear
              </button>
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl border border-emerald-600 text-emerald-600 hover:bg-emerald-50 text-xs font-bold transition cursor-pointer"
              >
                Save & Add Another
              </button>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold transition shadow-md shadow-emerald-600/20 cursor-pointer"
              >
        ...
        <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-xs p-6 max-w-2xl mx-auto space-y-6">
          <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#172033]">Record Bank Cash Deposit</h3>
                <p className="text-xs text-[#6B7280]">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs rounded-xl border border-[#E5E7EB] bg-[#FFF8F1]/40 text-[#172033] outline-none focus:border-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs rounded-xl border border-[#E5E7EB] bg-[#FFF8F1]/40 text-[#172033] outline-none focus:border-blue-500 font-bold"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-[#E5E7EB] rounded-xl p-4 text-center hover:border-blue-400 transition bg-[#FFF8F1]/40">
                {slipPreview ? (
                  <div className="flex items-center justify-between bg-white p-3 rounded-lg border border-[#E5E7EB]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-semibold text-[#172033] truncate max-w-xs">
                  ...
                  <label className="cursor-pointer block">
                    ...
                    <p className="text-[10px] text-[#6B7280] mt-0.5">JPG, PNG, WEBP or PDF up to 5MB</p>
            ...
            <div className="pt-3 border-t border-[#E5E7EB] flex items-center justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl border border-blue-600 text-blue-600 hover:bg-blue-50 text-xs font-bold transition cursor-pointer"
              >
                Save & Add Another
              </button>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition shadow-md shadow-blue-600/20 cursor-pointer"
              >
                {submitting ? 'Saving...' : 'Save & View Ledger'}
              </button>
            </div>
          ...
          <div className="bg-white rounded-2xl max-w-xl w-full border border-[#E5E7EB] shadow-2xl overflow-hidden animate-fadeIn">
            <div className="p-4 border-b border-[#E5E7EB] flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-[#172033]">Bank Deposit Slip</h3>
              </div>
              <button
                onClick={() => setViewSlipUrl(null)}
                className="p-1.5 text-[#6B7280] hover:text-[#172033] rounded-lg hover:bg-gray-100 cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="p-4 border-t border-[#E5E7EB] flex justify-between items-center bg-gray-50/50">
              ...
              <button
                onClick={() => setViewSlipUrl(null)}
                className="px-4 py-2 text-xs font-semibold rounded-xl bg-gray-200 text-[#172033] hover:bg-gray-300 transition cursor-pointer"
              >
                Close
              </button>
            </div>
      ...
      {editModalOpen && editingItem && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/60 backdrop-blur-md flex items-center justify-center p-4 transition-all duration-200">
          <div className="bg-white rounded-2xl max-w-lg w-full border border-[#E5E7EB] shadow-2xl overflow-hidden animate-fadeIn">
            <div className="p-4 border-b border-[#E5E7EB] flex items-center justify-between bg-orange-50/50">
              <div>
                <h3 className="text-base font-bold text-[#172033]">Edit {editingItem.type}</h3>
                <p className="text-xs text-[#6B7280] font-mono">{editingItem.entryCode}</p>
              </div>
              <button
                onClick={() => setEditModalOpen(false)}
                className="p-1.5 text-[#6B7280] hover:text-[#172033] rounded-lg hover:bg-white/60 cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <form onSubmit={handleUpdateRecord} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs rounded-xl border border-[#E5E7EB] bg-[#FFF8F1]/40 text-[#172033] outline-none"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-[#172033] mb-1">Amount (₹)</label>
                  <input
                    type="number"
                    min="1"
                    step="any"
                    ...
                    className="w-full px-3 py-2 text-xs rounded-xl border border-[#E5E7EB] bg-[#FFF8F1]/40 text-[#172033] outline-none font-bold"
                  />
                </div>
              </div>
              ...
              {editingItem.type === 'Additional Cash' && (
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-bold text-[#172033] mb-1">Reason</label>
                    <input
                      type="text"
                      required
                      value={editForm.reason}
                      onChange={(e) => setEditForm({ ...editForm, reason: e.target.value })}
                      className="w-full px-3 py-2 text-xs rounded-xl border border-[#E5E7EB] bg-[#FFF8F1]/40"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-[#172033] mb-1">
              ...
              {editingItem.type === 'Cash Deposit' && (
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-bold text-[#172033] mb-1">Bank Name</label>
                    <input
                      type="text"
                      required
                      value={editForm.bank}
                  ...
                  <div>
                    <label className="block text-xs font-bold text-[#172033] mb-1">Account</label>
                    <input
                      type="text"
                      required
              ...
              <div>
                <label className="block text-xs font-bold text-[#F97316] mb-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs rounded-xl border border-orange-300 bg-orange-50/40 outline-none"
                />
              </div>
              ...
              <div className="pt-3 border-t border-[#E5E7EB] flex justify-end gap-2">
                <button
                  type="button"
                  onClick={() => setEditModalOpen(false)}
                  className="px-4 py-2 text-xs font-semibold rounded-xl text-[#6B7280] hover:bg-gray-50 cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-5 py-2 text-xs font-bold rounded-xl bg-[#F97316] hover:bg-[#EA580C] text-white transition shadow-xs cursor-pointer"
                >
